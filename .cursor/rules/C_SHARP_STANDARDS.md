...
**优先级：** 与 [PACKAGE_CONSTRAINTS.md](PACKAGE_CONSTRAINTS.md)、[PACKAGE_ARCHITECTURE.md](PACKAGE_ARCHITECTURE.md) 同级；修改代码前必须同时遵守。
...
- **Tag 索引：** [PACKAGE_TAGS.md](PACKAGE_TAGS.md)、[config/package-tags.json](../../config/package-tags.json)
...
## 6. 分层与依赖（与 PACKAGE_CONSTRAINTS 一致）
...
- [ ] 命名空间与文件夹、asmdef 一致
- [ ] 未违反 [PACKAGE_CONSTRAINTS.md](PACKAGE_CONSTRAINTS.md) 分层
...
- [ ] 若变更涉及分层、归属、目录模板或 Tag，已同步更新 `.cursor/rules/` 对应边界文档（见 [unity-package-develop.mdc](unity-package-develop.mdc)）及 `config/package-tags.json`（如适用）
...
| 文档 | 内容 |
|------|------|
| [PACKAGE_CONSTRAINTS.md](PACKAGE_CONSTRAINTS.md) | 包职责、v2 API |
| [PACKAGE_ARCHITECTURE.md](PACKAGE_ARCHITECTURE.md) | 依赖图、归属速查 |
| [PACKAGE_TAGS.md](PACKAGE_TAGS.md) | 功能 Tag 词典 |
| [README.md](README.md) | 规则目录说明 |

元仓库安装与子模块列表：`config/registry.json`、[`docs/PACKAGES.md`](../../docs/PACKAGES.md)。
