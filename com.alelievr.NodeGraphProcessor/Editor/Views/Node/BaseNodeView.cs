		...
		public override void SetPosition(Rect newPos)
		{
            if (initializing || !nodeTarget.isLocked)
            {
				...
				if (!initializing)
				{
					...
					owner.graph.SortNodesByPosition();
					owner.UpdateSerializedProperties();
					owner.SyncSerializedPropertyPathes();
					owner.schedule.Execute(owner.UpdateEdgeExecutionOrderLabels).ExecuteLater(0);
				}
