...
{
    [Serializable, NodeMenuItem("Flow/Wait Frames")]
    ...
    public class WaitFrameMonoBehaviour : MonoBehaviour
    {
        ...
        {
            StartCoroutine(ProcessCoroutine(frame, callback));
        }

        private IEnumerator ProcessCoroutine(int frame, Action callback)
        {
